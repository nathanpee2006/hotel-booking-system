...
public class GUICommands {
    ...
    public GUICommands(MainWindow window, AuthService authService, BookingManager manager, IRoomRepository roomRepo, IBookingRepository bookRepo, DBManager db) {
        this.window = window;
    ...
    public void createBookingForSelectedRoom(String roomIdText) {
        try {
            ...
            if (user instanceof Customer customer) {
                ...
                bookingCustomer = (Customer) authService.createWalkInCustomer(name, email);
    ...
    public void checkInBooking(Booking booking, JPanel panel) {
        ...
        manager.checkInBooking(booking.getBookingId());
    ...
    public void approveBooking(Booking booking, ClerkPanel panel) {
        ...
        try {
            ...
            manager.completeBooking(booking.getBookingId());
